...
> 这个 skill 是我（[@iLLuvial](https://github.com/iLLuvial)）从一次次踩坑里调教出来的——中文乱码、base64 图挂掉、等宽字体、emoji 方块、`position: fixed` 失效……每一条规则背后都是一个翻车现场。详见 [《我是怎么调教出一个公众号排版 skill 的》](#相关阅读)。
...
git clone https://github.com/<你的用户名>/wechat-article-creator.git
...
*Made with 🦞 by [@iLLuvial](https://github.com/iLLuvial) — 一个不写代码也能造 AI 工具的普通人。*
